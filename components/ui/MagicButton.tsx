...
const MagicButton = ({
  ...
  return (
    <button onClick={handleClick} className="relative w-full inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none focus:ring-2 md:w-60 md:mt-10">
