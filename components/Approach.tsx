...
const Card = ({
  ...
  // Toggle tapped state on touch devices
  const handleTouch = () => setTapped((prev) => !prev);
        ...
        <div className="lg:hidden flex flex-col items-center">
          <div
            className={`text-center absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] min-w-40 mx-auto flex items-center justify-center transition duration-200 ${
              tapped ? "opacity-0 translate-y-4" : "opacity-100"
            }`}
          >
            {icon}
          </div>
          <h2
            className={`text-3xl font-bold mt-4 text-center transition duration-200 ${
              tapped
          ...
          <p
            className={`text-sm mt-4 text-center transition duration-200 ${
              tapped
                ? "opacity-100 text-white -translate-y-2"
                : "opacity-0"
            }`}
